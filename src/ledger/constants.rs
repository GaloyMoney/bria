...
pub(super) const CONFIRM_SPEND_ID: Uuid = uuid!("00000000-0000-0000-0000-000000000004");

pub(super) const QUEUED_PAYOUT_CODE: &str = "QUEUED_PAYOUT";
pub(super) const QUEUED_PAYOUD_ID: Uuid = uuid!("00000000-0000-0000-0000-000000000005");

pub(super) const CREATE_BATCH_CODE: &str = "CREATE_BATCH";
pub(super) const CREATE_BATCH_ID: Uuid = uuid!("00000000-0000-0000-0000-000000000006");
