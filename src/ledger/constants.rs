...
pub(super) const EFFECTIVE_INCOMING_ID: Uuid = uuid!("10000000-0000-0000-0000-000000000001");

pub(super) const EFFECTIVE_AT_REST_CODE: &str = "EFFECTIVE_AT_REST";
pub(super) const EFFECTIVE_AT_REST_ID: Uuid = uuid!("10000000-0000-0000-0000-000000000002");

pub(super) const EFFECTIVE_OUTGOING_CODE: &str = "EFFECTIVE_OUTGOING";
pub(super) const EFFECTIVE_OUTGOING_ID: Uuid = uuid!("10000000-0000-0000-0000-000000000003");
